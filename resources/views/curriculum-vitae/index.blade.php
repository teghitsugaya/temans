    ...
    <div class="bg-primary">
      <div class="container space-1">
        <div class="d-sm-flex justify-content-sm-between align-items-sm-center">
          ...
          <!-- Edit Profile -->
          <a class="btn btn-sm btn-soft-white transition-3d-hover" href="{{ url('curriculum-vitae/edit', Crypt::encryptString($curriculumVitae->id)) }}">
        ...
        <div class="row">
          <div class="col-lg-3 mb-7 mb-lg-0">
            ...
            <div class="card p-1 mb-4">
              <div class="card-body text-center">
                <div class="mb-3">
                  <img class="u-lg-avatar rounded-circle" src="{{ asset('data_profile')}}/{{ $curriculumVitae->file_foto }}" alt="Image Description">
                </div>
              ...
              <div class="card-body pt-3 pb-4 px-4">
                ...
                <a class="d-flex align-items-start mb-4" href="#">
                  <div class="position-relative u-avatar">
                    <img class="img-fluid rounded-circle" src="assets/img/badge/badge-silver.png" alt="Image Description">
                  
                  </div>

                  <div class="ml-3">
                    <span class="d-block text-dark">Silver</span>
                    <small class="d-block text-secondary">Done 10 e-learning</small>
                  </div>
                </a>
                <!-- End User -->
                ...
                <a class="d-flex align-items-start mb-4" href="#">
                  <div class="position-relative u-avatar">
                    <img class="img-fluid rounded-circle" src="assets/img/badge/badge-achievement2.png" alt="Image Description">
                  
                  </div>

                  <div class="ml-3">
                    <span class="d-block text-dark">Achievement</span>
                    <small class="d-block text-secondary">Got 2 Achievement</small>
                  </div>
                </a>
                <!-- End User -->
                ...
                <a class="d-flex align-items-start mb-4" href="#">
                  <div class="position-relative u-avatar">
                    <img class="img-fluid rounded-circle" src="assets/img/badge/badge-karyatulis2.png" alt="Image Description">
                  
                  </div>

                  <div class="ml-3">
                    <span class="d-block text-dark">Karya Tulis</span>
                    <small class="d-block text-secondary">Finish 3 Karya Tulis</small>
                  </div>
                </a>
                <!-- End User -->
                ...
                <a class="d-flex align-items-start mb-4" href="#">
                  <div class="position-relative u-avatar">
                    <img class="img-fluid rounded-circle" src="assets/img/badge/badge-organization2.png" alt="Image Description">
                  
                  </div>

                  <div class="ml-3">
                    <span class="d-block text-dark">Organization</span>
                    <small class="d-block text-secondary">Join 5 organization</small>
                  </div>
                </a>
                <!-- End User -->
              </div>
          ...
          <div class="col-lg-9">
            ...
            <div class="mb-4">
              ...
              <h4 class="h6 text-secondary mb-0">Kimia Farma Holding<small> - Last Updated: {{ $curriculumVitae->updated_at }}</small></h4>
            </div>
            <!-- End User Details -->
